...
Architecture and interface specifications live here. They are proposed contracts until a corresponding implementation and conformance evidence are published.
...
| [../conformance/README.md](../conformance/README.md) | Candidate binary fixtures, independent derivations, ABI registry, format, and verification commands |
