...
This is a synchronous Python research backend for two experimental first-block package profiles. It is not the planned C ABI, an FPGA driver, a multi-model scheduler, a host-tail evaluator, or a complete YOLO runtime.
